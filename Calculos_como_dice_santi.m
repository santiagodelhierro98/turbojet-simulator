...
T2 = Interpolar(8.36,9.02,Pr9i,490,500); %interpolamos para sacar la Temp total de Prt9i para alfa = 0.0338
T9i = Interpolar(0.0169,0.0338,alfa,T1,T2);

%Con T9i calculamos h9i
A1 = 0.0169;
A2 = 0.0338;
A = alfa;
