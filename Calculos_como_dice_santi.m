...
h_t9_10 = (((B2-B)/(B2-B1))*C11 + ((B-B1)/(B2-B1))*C12)*((A2-A)/(A2-A1)) + (((B2-B)/(B2-B1))*C21 + ((B-B1)/(B2-B1))*C22)*((A-A1)/(A2-A1));

cp_n = (h_t9_10*1000 - ht5*1000)/10;
V9 = fi_IsentropicVelocity*sqrt(2*cp_n*Tt9*((1-pi9^((1-gamma)/gamma))));
a=1;
